...
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 }, //133mhz fsb
	[1]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 }, //200mhz fsb
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 }, //200mhz fsb
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 }, //200mhz fsb
	[4]  = { {  594000, HFPLL, 1, 0x16 }, 1050000, 1050000, 3 }, //266mhz fsb
	[5]  = { {  648000, HFPLL, 1, 0x18 }, 1050000, 1050000, 4 }, //400mhz fsb
	[6]  = { {  702000, HFPLL, 1, 0x1A }, 1150000, 1150000, 4 }, //400mhz fsb
	[7]  = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1150000, 4 }, //400mhz fsb
	[8]  = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1150000, 4 }, //400mhz fsb
	[9]  = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1150000, 4 }, //400mhz fsb
	[10] = { {  918000, HFPLL, 1, 0x22 }, 1150000, 1150000, 7 }, //533mhz fsb
	[11] = { {  972000, HFPLL, 1, 0x24 }, 1150000, 1150000, 7 }, //533mhz fsb
	[12] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1150000, 7 }, //533mhz fsb
	[13] = { { 1080000, HFPLL, 1, 0x28 }, 1150000, 1150000, 7 }, //533mhz fsb
	[14] = { { 1134000, HFPLL, 1, 0x2A }, 1150000, 1150000, 7 }, //533mhz fsb
	[15] = { { 1350000, HFPLL, 1, 0x32 }, 1150000, 1150000, 7 }, //533mhz fsb
	[16] = { { 1566000, HFPLL, 1, 0x3A }, 1150000, 1150000, 8 }, //566mhz fsb
	{ }
};
...
static struct acpu_level tbl_PVS1_1700MHz[] __initdata = {
	...
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(13), 1012500 },
...
static struct acpu_level tbl_PVS4_1700MHz[] __initdata = {
	...
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(13),  925000 },
